...
const Hero = () => {
  ...
  return (
    <section className="relative h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-vscode-dark via-purple-900/20 to-blue-900/20">
        {!videoError && (
          <video
            ref={videoRef}
        ...
        {videoError && (
          <div className="w-full h-full bg-gradient-to-br from-gray-900 via-blue-900/30 to-purple-900/30 animate-pulse" />
        )}
      </div>
